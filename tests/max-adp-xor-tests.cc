...
void test_max_adp_xor()
{
  ...
  WORD_T da = MASK;//~0ULL;//0xffffffff;//gen_sparse(8, WORD_SIZE);//0xffffffff;//random32() & MASK;
  WORD_T db = MASK;//~0ULL;//0xffffffff;//gen_sparse(8, WORD_SIZE);//0xffffffff;//random32() & MASK;
  WORD_T dc = 0;
